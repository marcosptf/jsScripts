...
$(document).ready(function() {
    ...
    $("#sltPreco1, #sltPreco2").numeric({decimal: false, negative: false}, function() {
    ...
    $('#fi').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas fiat");
    }, function() {
        $("ul.marcas").removeClass("fiat");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas ford");
    ...
    $('#for').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas ford");
    }, function() {
        $("ul.marcas").removeClass("ford");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas chevrolet");
    ...
    $('#gm').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas chevrolet");
    }, function() {
        $("ul.marcas").removeClass("chevrolet");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas renault");
    ...
    $('#ren').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas renault");
    }, function() {
        $("ul.marcas").removeClass("renault");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas toyota");
    ...
    $('#toy').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas toyota");
    }, function() {
        $("ul.marcas").removeClass("toyota");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas volkswagen");
    ...
    $('#vw').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas volkswagen");
    }, function() {
        $("ul.marcas").removeClass("volkswagen");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas peugeot");
    ...
    $('#peu').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas peugeot");
    }, function() {
        $("ul.marcas").removeClass("peugeot");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas honda");
    ...
    $('#hon').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas honda");
    }, function() {
        $("ul.marcas").removeClass("honda");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas mitsubishi");
    ...
    $('#mit').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas mitsubishi");
    }, function() {
        $("ul.marcas").removeClass("mitsubishi");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas nissan");
    ...
    $('#nis').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas nissan");
    }, function() {
        $("ul.marcas").removeClass("nissan");
    });
...
//            $("button.marcas").removeClass().toggleClass("marcas hyundai");
    ...
    $('#hyu').hover(function() {
        $("ul.marcas").removeClass().toggleClass("marcas hyundai");
    }, function() {
        $("ul.marcas").removeClass("hyundai");
    });
